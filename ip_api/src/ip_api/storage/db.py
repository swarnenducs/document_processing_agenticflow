"""SQLAlchemy 2.x engine for Azure SQL (document processing) or local SQLite."""
...
def _migrate_mssql_document_tables(engine: Engine) -> None:
    ...
    Azure Portal 'Edit data' often renders VARCHAR(MAX) JSON columns as empty,
    which makes job_table_document_mcp / accuracy_report_document_mcp look blank.
    """
    from sqlalchemy import inspect, text
