...
A: Load → split → embed → vector store (index). Query: embed question → retrieve top-k → prompt(context, question) → LLM. See `docs/interview-prep/langchain-basic/03-rag-with-langchain.md`.
